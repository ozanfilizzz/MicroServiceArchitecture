using MicroServiceArchitectureProducts.DataAccess.Context;
...
namespace MicroServiceArchitectureProducts
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                {
                    Title = "MicroServiceArchitectureProducts",
                    Version = "v1"
                });
            });
            #endregion
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(s => s.SwaggerEndpoint("/swagger/v1/swagger.json", "MicroServiceArchitectureProducts v1"));
            }
